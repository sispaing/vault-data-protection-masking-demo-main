...
if __name__ == '__main__':
  ...
  try:
      ...
      if conf['VAULT']['Enabled'].lower() == 'true':
        ...
        if conf['VAULT']['Transform'].lower() == 'true':
          ...
          try:
            ...
            logging.error("There was an error starting the server_test: {}".format(e))
        vault_token = ""
        if conf['VAULT']['InjectToken'].lower() == 'true':
          logger.info('Using Injected vault token')
          if conf['VAULT']['Vault_Agent'].lower() == 'true':
             logger.info('Using Vault Agent Sink Token')
    ...
    logging.error("There was an error starting the server_last: {}".format(e))